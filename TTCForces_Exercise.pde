...
void setup(){
  ...
  agentPos[3] = new Vec2(420,250);
  agentPos[4] = new Vec2(520,360);
  goalPos[0] = new Vec2(200,420);
  goalPos[1] = new Vec2(120,120);
  goalPos[2] = new Vec2(220,220);
  goalPos[3] = new Vec2(20,410);
  goalPos[4] = new Vec2(330,20);
...
Vec2 computeAgentForces(int id){
  ...
  Vec2 goal = (goalPos[id].minus(agentPos[id])).times(k_goal);
