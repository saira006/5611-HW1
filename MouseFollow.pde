...
//     very useful, be sure to check them out for general Processing help.) (because the third argument is the width/height which is the diameter of circle)
...
void update(float dt){
  ...
  if(pos.distanceTo(mousePos) <= 1.0) { return; }
